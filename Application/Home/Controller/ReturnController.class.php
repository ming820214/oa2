...
//         if($_POST['school'])$w['school']=$_POST['school'];
        ...
        $output .= "<tr><td>序号</td><td>状态</td><td>期次</td><td>区域</td><td>校区</td><td>学员姓名</td><td>年级</td><td>联系电话</td><td>教学主任</td><td>学习管理师</td><td>课程类型</td><td>首次缴费日期</td><td>退出费用缴费时间</td><td>交费总额</td><td>缴费课时数</td><td>已上课时</td><td>科目/教师</td><td>剩余计算</td><td>应退金额</td><td>退费原因</td><td>校区反馈</td><td>总部沟通</td><td>部门审核时间</td><td>办理人</td><td>申请时间</td><td>退费人</td><td>财务审批时间</td><td>退费时间</td><td>备注</td></tr>";
            foreach ($mm as $m) {
                switch ($m['state']) {
                    case '0':
                        $state='退回修改';
