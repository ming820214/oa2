...
class  SchoolGradeViewModel extends Model {
    ...
    protected $connection = 'mysql://root:ihongwen@localhost:3306/hw001';
    // protected $dbName = 'hw001';

  // 	protected $viewFields=array(
  //   		'SchoolGrade'=>array('id','school','name','is_del'),
  //   		'StuGrade'=>array('course_id','_on'=>'SchoolGrade.id=StuGrade.gid'),
  //   		'Student'=>array('name'=>'student_name','_on'=>'StuGrade.stuid=Student.id')
		// );
